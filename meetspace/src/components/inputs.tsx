...
export const ChatQueryInput = ({onButtonClick, textHolder}: inputProps) => {
    const Isvalid_Placeholder = ((typeof(textHolder) !== null) && (typeof(textHolder) === "string"));
    return (
        <div>
            <div className = "">
                <input placeholder={`${Isvalid_Placeholder? textHolder: "Placeholder for the input element..."}`} className=""/>
